...
- **Academic contributions:** Teaching assistantships, publications, and conference presentations; see the [publications]({{ "/publications/" | relative_url }}) and [talks]({{ "/en/talks/" | relative_url }}) sections for details.
...
For a concise executive summary, see the [About page]({{ "/en/about/" | relative_url }}). For project outcomes, visit the [case studies]({{ "/en/case-studies/" | relative_url }}) page.
