...
You can change or revoke consent at any time through the banner controls. See the <a href="{{ "/cookies/" | relative_url }}">cookies page</a> for more on storage, and reach out via the <a href="{{ "/contact/" | relative_url }}">contact page</a> with any questions.
