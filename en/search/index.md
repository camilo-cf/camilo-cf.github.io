...
i18n_key: "search"
ref: "search"
description: "Search blog posts, case studies, and technical content on production ML, GenAI, MLOps, and causal measurement."
---

<div class="search-container">
  <label for="search-input" class="search-label">
    <strong>Search posts, case studies, and pages:</strong>
  </label>
  <input 
    type="search" 
    id="search-input" 
    placeholder="e.g., GenAI evaluation, rollback, causal ads..." 
    class="search-input"
    autocomplete="off"
  >
  ...
  <p id="search-empty" class="search-empty" style="display:none;">
    No results found. Try different keywords or <a href="{{ "/en/blog/" | relative_url }}">browse all posts</a>.
  </p>
</div>
